...
<?if(!empty($arResult["ITEMS"])):?>
	...
	<div id="personalCart">
		...
		<a <?if($arResult["SUM"] < 30){?>style="display: none"<?}?> href="<?=SITE_DIR?>personal/cart/order/" id="newOrder" class="selected"><img src="<?=SITE_TEMPLATE_PATH?>/images/order.png"><?=GetMessage("BASKET_TABS_ORDER_MAKE")?></a>
		<p <?if($arResult["SUM"] > 30){?>style="display: none"<?}?> id="newOrderMinimalPrice">
			The minimum order value 30 USD
		</p>
