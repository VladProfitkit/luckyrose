...
<div class="webFormDw" data-id="<?=$arResult["arForm"]["ID"]?>">
	...
	<?if($arResult["isFormNote"] != "Y"):?>
		...
		<div class="webFormTools">
			<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" class1="sendWebFormDw" />
