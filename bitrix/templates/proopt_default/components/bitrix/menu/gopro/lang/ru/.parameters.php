<?
$MESS['RSGOPRO.SUB_TEMPLATE'] = 'Вид меню';
$MESS['RSGOPRO.SUB_TEMPLATE.horizontal1'] = 'Горизонтальное меню';
$MESS['RSGOPRO.SUB_TEMPLATE.vertical1'] = 'Вертикальное меню-лесенка';
$MESS['RSGOPRO.SUB_TEMPLATE.vertical2'] = 'Вертикальное меню-шторка';
