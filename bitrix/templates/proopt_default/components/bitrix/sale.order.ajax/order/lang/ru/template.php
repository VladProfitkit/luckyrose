...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением и статусом своего заказа в <a href=\"#LINK#\">истории заказов в Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
