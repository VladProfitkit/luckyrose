<div id="appFastBuy" data-load="<?=SITE_TEMPLATE_PATH?>/images/picLoad.gif">
	<div id="appFastBuyContainer">
		<div class="heading">Buy one-click <a href="#" class="close closeWindow"></a></div>
		<div class="container" id="fastBuyOpenContainer">
			...
			<div class="column">
				<div class="title">Complete ordering information</div>
				<form action="<?=SITE_DIR?>callback/" id="fastBuyForm" method="GET">
					...
					<div class="formLine"><a href="#" id="fastBuyFormSubmit"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="Buy one-click">Buy one-click</a></div>
				</form>
			</div>
		</div>
